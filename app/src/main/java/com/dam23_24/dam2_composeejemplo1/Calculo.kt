...
class Calculo {
    ...
    companion object{
        ...
        private var msjPpal: String = ""
        private var msjDetalle: String = ""
         ...
         *
         * @param num que corresponde al dígito del 0 al 9 pulsado.
         */
        private fun pulsaDigito(num: Int) {
        ...
        /**
         * Añade el punto decimal, si es posible, a la información en cadenas de caracteres
         * (this.numTemp1 y this.numTemp2).
         */
        private fun pulsaPuntoDec() {
         ...
         *        (por defecto es true)
         */
        private fun pulsaReset(resetNumCalculos: Boolean = true, resetResult: Boolean = true) {
            this.num1 = 0f
            this.num2 = 0f
            this.op = -1
         ...
         * 3 = Dividir).
         */
        private fun pulsaOperador(num: Int) {
         ...
         */
        private fun pulsaResult(): Boolean {
            ...
            if (!this.primerNum && this.numTemp2 != "") {
                ...
                pulsaReset(resetNumCalculos = false, resetResult = false)
                return true
            } else {
                return false
            }
         ...
         */
        private fun pulsaBorrar(): Boolean {
        ...
        /**
         * Controla la pulsación de cualquier botón de la calculadora
         *
         * @param num info que sirve para decidir que método privado debe lanzarse en cada caso.
         *
         * @return Boolean indicando si se pudo realizar correctamente el método lanzado
         *         (solo se usa para el caso de realizar el cálculo o borrar un dígito)
         */
        fun pulsaBoton(num: Int): Boolean {

            var result = true

            when (num) {
                in 0..9 -> pulsaDigito(num)
                10 -> pulsaPuntoDec()
                11 -> pulsaReset()
                12 -> pulsaOperador(0)
                13 -> pulsaOperador(1)
                14 -> result = pulsaResult()
                15 -> pulsaOperador(2)
                16 -> pulsaOperador(3)
                17 -> result = pulsaBorrar()
            }
        ...
        /**
         * Método Get para obtener el valor de la propiedad privada msjPpal
         */
        fun getMsjPpal(): String {
            return this.msjPpal
        }


        /**
         * Método Get para obtener el valor de la propiedad privada msjDetalle
         */
        fun getMsjDetalle(): String {
            return this.msjDetalle
        }
